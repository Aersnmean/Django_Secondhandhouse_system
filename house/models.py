...
class HouseInfo(mongoengine.Document):
    ...
    bedroom = mongoengine.ListField(max_length=20, verbose_name='室厅')
    ...
    add_date = mongoengine.StringField(verbose_name='发布时间')
    the_host = mongoengine.StringField(verbose_name='房主')
